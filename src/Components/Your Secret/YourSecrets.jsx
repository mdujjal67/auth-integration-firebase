...
const YourSecrets = () => {
    return (
        <div className="text-center">
            <h1 className="text-3xl font-bold mb-5">Your all secret carts are here:</h1>
            <div className="flex mx-auto flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-50 dark:text-gray-800" bis_skin_checked="1">
                <h2 className="text-xl font-semibold">Your cart</h2>
                <ul className="flex flex-col divide-y dark:divide-gray-300">
                    <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                        <div className="flex w-full space-x-2 sm:space-x-4" bis_skin_checked="1">
                            ...
                            <div className="flex flex-col justify-between w-full pb-4" bis_skin_checked="1">
                                <div className="flex justify-between w-full pb-2 space-x-2" bis_skin_checked="1">
                                    ...
                                    <div className="text-right" bis_skin_checked="1">
                ...
                <div className="flex justify-end space-x-4" bis_skin_checked="1">
                    <Link to="/" type="button" className="px-6 py-2 border  rounded-md dark:border-violet-600">Back
