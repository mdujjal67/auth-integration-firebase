...
const Profile = () => {
    ...
    return (
        <div>
            <div className="flex mx-auto flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800" bis_skin_checked="1">
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300" bis_skin_checked="1">
                    <div className="my-2 space-y-1" bis_skin_checked="1">
                        ...
                        <p className="px-5 text-xs sm:text-base dark:text-gray-600">General User</p>
                    </div>
                    <div className="flex justify-center pt-2 space-x-4 align-center" bis_skin_checked="1">
